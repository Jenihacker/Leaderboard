    ...
    <Reorder.Group as="table" className="table-fixed" axis="y" values={data} onReorder={setdata}>
      <thead>
        <tr className="flex justify-between mx-5 mr-6">
          ...
          <th className="font-semibold text-xl font-poppins mx-10">Credits</th>
      ...
      <tbody>
        {data.map((e: Teams, index: number) => (
          ...
          >
            ...
            <td className="flex justify-start items-center w-full sm:min-w-[280px] lg:min-w-[280px] lg:pl-16 ">
